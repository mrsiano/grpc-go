...
[`credentials.PerRPCCredentials`](https://godoc.org/github.com/mrsiano/grpc-go/credentials#PerRPCCredentials).
...
https://godoc.org/github.com/mrsiano/grpc-go/credentials/oauth for details.
...
[`WithPerRPCCredentials`](https://godoc.org/github.com/mrsiano/grpc-go#WithPerRPCCredentials).
Or, if user wants to apply OAuth token per call, then configure the grpc RPC
call with `CallOption`
[`PerRPCCredentials`](https://godoc.org/github.com/mrsiano/grpc-go#PerRPCCredentials).
