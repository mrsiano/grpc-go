...
[`UnaryClientInterceptor`](https://godoc.org/github.com/mrsiano/grpc-go#UnaryClientInterceptor)
...
`DialOption`
[`WithUnaryInterceptor`](https://godoc.org/github.com/mrsiano/grpc-go#WithUnaryInterceptor).

#### Stream Interceptor

[`StreamClientInterceptor`](https://godoc.org/github.com/mrsiano/grpc-go#StreamClientInterceptor)
...
`DialOption`
[`WithStreamInterceptor`](https://godoc.org/github.com/mrsiano/grpc-go#WithStreamInterceptor).
...
[`UnaryServerInterceptor`](https://godoc.org/github.com/mrsiano/grpc-go#UnaryServerInterceptor)
...
`ServerOption`
[`UnaryInterceptor`](https://godoc.org/github.com/mrsiano/grpc-go#UnaryInterceptor).

#### Stream Interceptor

[`StreamServerInterceptor`](https://godoc.org/github.com/mrsiano/grpc-go#StreamServerInterceptor)
...
`ServerOption`
[`StreamInterceptor`](https://godoc.org/github.com/mrsiano/grpc-go#StreamInterceptor).
