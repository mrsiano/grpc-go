...
import (
	...
	_ "github.com/mrsiano/grpc-go/balancer/rls"                      // Register the RLS LB policy.
	_ "github.com/mrsiano/grpc-go/xds/internal/balancer/cdsbalancer" // Register the CDS LB policy.
)
