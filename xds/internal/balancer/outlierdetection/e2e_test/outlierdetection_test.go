...
import (
	...
	_ "github.com/mrsiano/grpc-go/xds/internal/balancer/outlierdetection" // To register helper functions which register/unregister Outlier Detection LB Policy.
)
