...
https://godoc.org/github.com/mrsiano/grpc-go/keepalive for the options.
...
parameters](https://godoc.org/github.com/mrsiano/grpc-go/keepalive) as a [dial
option](https://godoc.org/github.com/mrsiano/grpc-go#WithKeepaliveParams).
...
parameters](https://godoc.org/github.com/mrsiano/grpc-go/keepalive#ServerParameters)
for details.

### Enforcement policy

[Enforcement
policy](https://godoc.org/github.com/mrsiano/grpc-go/keepalive#EnforcementPolicy) is
