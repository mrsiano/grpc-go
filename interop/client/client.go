...
import (
	...
	"github.com/mrsiano/grpc-go/credentials/oauth"
	...
	_ "github.com/mrsiano/grpc-go/balancer/grpclb"      // Register the grpclb load balancing policy.
	_ "github.com/mrsiano/grpc-go/balancer/rls"         // Register the RLS load balancing policy.
	_ "github.com/mrsiano/grpc-go/xds/googledirectpath" // Register xDS resolver required for c2p directpath.
